...
class AggregationElement implements IElement {
	...
	static
	final Map<String, List<Type>> PREDICATE_TYPES = ["count": [], "min": [TYPE_INT], "max": [TYPE_INT], "sum": [TYPE_INT]]
	static
	final Map<String, Type> PREDICATE_RET_TYPE = ["count": TYPE_INT, "min": TYPE_INT, "max": TYPE_INT, "sum": TYPE_INT]
}
